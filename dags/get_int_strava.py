...
default_args = {
    ...
    'start_date': datetime(2016, 4, 22) - timedelta(days=7),
...
def clean_data(ti):
    ...
    df.to_csv(os.path.join(target_directory, 'Strava_update.csv'), index=False)
